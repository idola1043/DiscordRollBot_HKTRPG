...
function parseInput(inputStr) {
	...
	//tarot 指令
	if (trigger.match(/-tarot|ainah/) != null) {
		if (trigger.match(/^ehye-|^!daily/) != null) return exports.funny.NomalDrawTarot(mainMsg[1], mainMsg[2]); //預設抽 79 張
		if (trigger.match(/^yar-|^!time/) != null) return exports.funny.MultiDrawTarot(mainMsg[1], mainMsg[2], 1);
		if (trigger.match(/^throdog-|^!cross/) != null) return exports.funny.MultiDrawTarot(mainMsg[1], mainMsg[2], 2);
	}
